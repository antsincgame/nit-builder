    ...
    },
    {
      ...
      body: (
        <>
          ...
          («сайт для кофейни в Минске»), или выберите готовый шаблон. Через минуту
          сайт готов: скачайте HTML, версию с PHP-редактором для хостинга или
