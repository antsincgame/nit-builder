        ...
        <article className="fade-in-up prose prose-invert max-w-none">
          ...
          <div className="space-y-5 text-sm text-[#71717A] leading-relaxed">
            <p>
              ...
              генерирует сайт по вашему описанию — и делает это прямо на вашем компьютере — бесплатно для личного использования.
            </p>

            <p>
              Если вы искали способ <strong className="text-[#A1A1AA]">создать сайт бесплатно без знания кода</strong>,
              nitgen решает эту задачу. Опишите свой проект одним предложением — нейросеть создаст готовый HTML-сайт. Не нужно разбираться в программировании, CSS или JavaScript.
            </p>
            ...
            <p>
              ...
              бесплатную программу для запуска нейросетей локально. Это значит, что ваши описания обрабатываются на вашем железе,
              а не в чужих облачных нейросетях.
            </p>
