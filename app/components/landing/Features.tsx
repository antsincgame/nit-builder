...
import { Shield, Banknote, Zap, Globe, Lock, Cpu } from "lucide-react";

const cards = [
  {
    icon: <Lock size={20} />,
    title: "Данные не покидают ваш ПК",
    desc: "Создание сайта через ИИ происходит локально. Ни ваш текст, ни результат не отправляются на серверы. Полная конфиденциальность при генерации сайтов нейросетью.",
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    desc: "Генератор сайтов на ИИ работает офлайн через LM Studio. Создавайте сайты нейросетью даже без подключения к сети.",
  },
  {
    icon: <Shield size={20} />,
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="text-center mb-14 fade-in-up">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white mb-4">
            Бесплатный генератор сайтов на ИИ
          </h2>
          <p className="text-[#71717A] text-lg max-w-2xl mx-auto">
            Всё, что нужно для создания сайтов с помощью нейросети — бесплатно, безопасно, без ограничений
          </p>
        </div>
        ...
        <div className="mt-12 fade-in-up">
          <p className="text-center text-sm text-[#71717A] max-w-2xl mx-auto leading-relaxed">
            ...
            визитка. Искусственный интеллект генерирует сайты на основе вашего описания — без шаблонов, без ограничений по дизайну.
