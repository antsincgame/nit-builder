/**
 * FreeForeverSection — большой блок "0€ навсегда" + сравнение цен.
 * Акцент на бесплатности. Показываем сколько бы стоил год Bolt/v0/Tilda.
 */
...
export function FreeForeverSection({ isAuthed }: Props) {
  return (
    ...
    >
      {/* Subtle green glow в фоне */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: "radial-gradient(ellipse 50% 40% at 50% 50%, rgba(34, 197, 94, 0.06), transparent 70%)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-8 sm:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-6 sm:mt-8">
              <a href={isAuthed ? "/app" : "/register"} className="btn-primary">
                Начать бесплатно
