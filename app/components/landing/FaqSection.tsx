...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "Пока нет. Это в roadmap (v3.0+) — концепт «один член команды держит туннель, остальные используют через расшаренный ключ». Сейчас 1 туннель = 1 пользователь. Но архитектурно мы готовы — `tunnelRegistry` уже поддерживает multi-tab browser на один tunnel.",
  },
  {
