...
> = {
  windows: {
    filename: "NIT.Tunnel_0.2.2_x64-setup.exe",
    label: "Windows",
  },
  "macos-arm": {
    filename: "NIT.Tunnel_0.2.2_aarch64.dmg",
    label: "macOS Apple Silicon",
  },
  "macos-intel": {
    filename: "NIT.Tunnel_0.2.2_x64.dmg",
    label: "macOS Intel",
  },
  linux: {
    // Фактическое имя из релиза tunnel-desktop-v0.2.2: Tauri бандлит
    // AppImage/deb по productName ("NIT Tunnel" → NIT.Tunnel), а не lowercase.
    filename: "NIT.Tunnel_0.2.2_amd64.AppImage",
    label: "Linux AppImage",
  },
  "linux-deb": {
    filename: "NIT.Tunnel_0.2.2_amd64.deb",
